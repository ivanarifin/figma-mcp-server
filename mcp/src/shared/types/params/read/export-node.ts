...
export const ExportNodeParamsSchema = z.object({
    ...
    outputDir: z.string().optional().describe("Optional output directory. Defaults to <current workspace>/assets. If the project has a specific asset folder, pass that path explicitly, e.g. src/assets, public/images, or app/assets."),
